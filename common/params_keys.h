...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AutoTurnControlSpeedTurn", {PERSISTENT, INT, "40"}},
    ...
    {"AutoNaviSpeedDecelRate", {PERSISTENT, INT, "50"}},
    ...
    {"CruiseMaxVals1", {PERSISTENT, INT, "125"}},
    ...
    {"TFollowGap1", {PERSISTENT, INT, "105"}},
    ...
    {"UseLaneLineSpeed", {PERSISTENT, INT, "10"}},
    {"UseLaneLineCurveSpeed", {PERSISTENT, INT, "10"}},

    {"AdjustLaneOffset", {PERSISTENT, INT, "0"}},
    {"LaneChangeNeedTorque", {PERSISTENT, INT, "0"}},
    {"LaneChangeDelay", {PERSISTENT, INT, "2"}},
    ...
    {"LatMpcPathCost", {PERSISTENT, INT, "160"}},
