...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"ShowPathMode", {PERSISTENT, INT, "0"}},
    {"ShowPathColor", {PERSISTENT, INT, "20"}},
    ...
    {"ShowCustomBrightness", {PERSISTENT, INT, "60"}},
    ...
    {"AutoTurnControlSpeedTurn", {PERSISTENT, INT, "29"}},
    {"AutoTurnControlTurnEnd", {PERSISTENT, INT, "4"}},
    ...
    {"AutoNaviSpeedBumpSpeed", {PERSISTENT, INT, "29"}},
    {"AutoNaviSpeedDecelRate", {PERSISTENT, INT, "80"}},
    ...
    {"CruiseButtonTest2", {PERSISTENT, INT, "15"}},
    ...
    {"CruiseOnDist", {PERSISTENT, INT, "600"}},

    {"CruiseMaxVals0", {PERSISTENT, INT, "110"}},
    {"CruiseMaxVals1", {PERSISTENT, INT, "90"}},
    {"CruiseMaxVals2", {PERSISTENT, INT, "75"}},
    {"CruiseMaxVals3", {PERSISTENT, INT, "65"}},
    ...
    {"SoundVolumeAdjustEngage", {PERSISTENT, INT, "60"}},

    {"TFollowGap1", {PERSISTENT, INT, "80"}},
    {"TFollowGap2", {PERSISTENT, INT, "100"}},
    {"TFollowGap3", {PERSISTENT, INT, "120"}},
    {"TFollowGap4", {PERSISTENT, INT, "140"}},

    {"DynamicTFollow", {PERSISTENT, INT, "0"}},
    {"DynamicTFollowLC", {PERSISTENT, INT, "80"}},
    {"TFollowDecelBoost", {PERSISTENT, INT, "20"}},
    {"EnableSpeedTF", {PERSISTENT, INT, "0"}},
    {"AChangeCostStarting", {PERSISTENT, INT, "15"}},
    {"TrafficStopDistanceAdjust", {PERSISTENT, INT, "-50"}},

    {"HapticFeedbackWhenSpeedCamera", {PERSISTENT, INT, "0"}},
    {"UseLaneLineSpeed", {PERSISTENT, INT, "15"}},
    ...
    {"LatMpcMotionCost", {PERSISTENT, INT, "9"}},
    ...
    {"LateralTorqueFriction", {PERSISTENT, INT, "0"}},
    {"LateralTorqueKpV", {PERSISTENT, INT, "140"}},
    ...
    {"SteerRatioRate", {PERSISTENT, INT, "98"}},
