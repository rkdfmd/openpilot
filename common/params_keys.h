...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AutoRoadSpeedLimitOffset", {PERSISTENT, INT, "5"}},
    {"AutoNaviSpeedBumpTime", {PERSISTENT, INT, "7"}},
    ...
    {"StoppingAccel", {PERSISTENT, INT, "-3"}},
    ...
    {"CruiseSpeed1", {PERSISTENT, INT, "110"}},
    {"CruiseSpeed2", {PERSISTENT, INT, "110"}},
    {"CruiseSpeed3", {PERSISTENT, INT, "110"}},
    {"CruiseSpeed4", {PERSISTENT, INT, "110"}},
    {"CruiseSpeed5", {PERSISTENT, INT, "110"}},

    {"PaddleMode", {PERSISTENT, INT, "0"}},
    {"MyDrivingMode", {PERSISTENT, INT, "3"}},
    {"MyDrivingModeAuto", {PERSISTENT, INT, "1"}},
